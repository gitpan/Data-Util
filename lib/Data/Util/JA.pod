...
名前付きサブルーチンI<&package::name>として命名します。
...
C<subr(2, 3, 1)>が呼び出され，カリー化サブルーチンに与えられた
C<$_[0]>(つまり0)が無視されます。
